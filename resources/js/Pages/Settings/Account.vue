...
<template>
    <AppLayout title="Settings">
        <div class="flex h-screen bg-white">
            <!-- Sidebar -->
            <div class="w-64 flex-shrink-0 border-r border-gray-100 p-6">
                
                <div class="flex items-center gap-2 mb-8 text-xl font-bold">
                    <Link :href="route('dashboard')" class="text-gray-400 hover:text-black transition">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path></svg>
                    </Link>
                    <span>Settings</span>
                </div>

                <nav class="space-y-4 text-sm font-medium text-gray-500">
                    <div @click="activeSection = 'account'" :class="{'text-purple-600 font-bold bg-purple-50': activeSection === 'account', 'hover:text-black hover:bg-gray-50': activeSection !== 'account'}" class="flex items-center gap-3 p-2 rounded-lg cursor-pointer transition">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path></svg>
                        Account
                    </div>
                    <div @click="activeSection = 'calendars'" :class="{'text-purple-600 font-bold bg-purple-50': activeSection === 'calendars', 'hover:text-black hover:bg-gray-50': activeSection !== 'calendars'}" class="flex items-center gap-3 p-2 rounded-lg cursor-pointer transition">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                        Connected calendars
                    </div>
                     <div class="flex items-center gap-3 hover:text-black hover:bg-gray-50 p-2 rounded-lg cursor-pointer transition">
                ...
                <div class="absolute bottom-6 left-6 space-y-4 text-xs font-bold text-gray-500">
                    <div class="hover:text-black cursor-pointer flex justify-between">Frequently Asked Questions <span class="text-gray-300">↗</span></div>
                    <div class="hover:text-black cursor-pointer flex justify-between">Privacy Policy <span class="text-gray-300">↗</span></div>
                    <div class="hover:text-black cursor-pointer flex justify-between">Cookie Policy <span class="text-gray-300">↗</span></div>
                    <div class="hover:text-black cursor-pointer flex justify-between">Terms of service <span class="text-gray-300">↗</span></div>
                    
                    <button class="bg-gray-200 hover:bg-gray-300 text-gray-700 font-bold py-2 px-4 rounded-full mt-4 w-24">Log out</button>
                </div>
            </div>
            ...
            <div class="flex-1 p-12 overflow-y-auto">
                <div v-if="activeSection === 'account'">
                    ...
                    <div class="space-y-12 max-w-2xl">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div class="font-bold text-gray-900">Profiles</div>
                            <div class="md:col-span-2 space-y-4">
                                ...
                                <button @click="openFeatureModal('Add Profile', 'Multiple profiles are coming soon!')" class="bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold py-1.5 px-4 rounded-full text-xs transition">
                                    Add profile +
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div class="md:col-span-2 space-y-4">
                                ...
                                <div class="flex gap-3">
                                    <button @click="confirmingEmailChange = true" class="bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold py-1.5 px-4 rounded-full text-xs transition">Change email</button>
                                    <button @click="confirmingUserDeletion = true" class="bg-white border border-gray-200 hover:bg-gray-50 text-gray-700 font-bold py-1.5 px-4 rounded-full text-xs transition">Delete account</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Subscription -->
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div class="font-bold text-gray-900">Subscription</div>
                            <div class="md:col-span-2">
                                <button @click="manageSubscription" class="bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold py-1.5 px-4 rounded-full text-xs transition">
                        ...
                        <!-- Send messages -->
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div class="font-bold text-gray-900">Send messages</div>
                            <div class="md:col-span-2 space-y-4">
                                ...
                                <div class="flex items-center justify-between">
                                    <span class="text-sm font-medium text-gray-700">Newsletters and offers</span>
                                    <!-- Toggle Switch -->
                ...
                <div v-if="activeSection === 'calendars'">
                    <h1 class="text-3xl font-bold font-serif mb-2">Connected calendars</h1>
                    <p class="text-gray-500 mb-12">Manage third-party accounts and connect your favorite tools to Tiimo</p>

                    <div class="space-y-8">
                        <div>
                            <div class="flex justify-between items-center mb-6">
                                <h2 class="text-xl font-bold">Your calendars</h2>
                                <div class="flex gap-3">
                                    <button @click="confirmingICloudConnection = true" class="bg-white border border-gray-200 hover:bg-gray-50 text-gray-700 font-bold py-2 px-4 rounded-full text-sm transition flex items-center gap-2">
                                    ...
                                    <a :href="route('google.auth')" class="bg-white border border-gray-200 hover:bg-gray-50 text-gray-700 font-bold py-2 px-4 rounded-full text-sm transition flex items-center gap-2 cursor-pointer">
                            ...
                            <div class="border-2 border-dashed border-gray-200 rounded-xl p-8 flex flex-col items-center justify-center text-center min-h-[160px]">
                                ...
                                <h3 class="font-bold text-lg mb-1">You have no connected calendars.</h3>
                                <p class="text-gray-500">Set yourself up for success and import your calendar to have all your tasks one place.</p>
                            </div>
                        </div>
                    </div>
                </div>
